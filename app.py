...
try:
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://HarrisonZoccoli@wingit-db:qwert123$Benny123$@wingit-db.postgres.database.azure.com:5432/postgres?sslmode=require'
