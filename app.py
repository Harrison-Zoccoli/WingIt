...
try:
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://HarrisonZoccoli%40wingit-db:qwert123%24Benny123%24@wingit-db.postgres.database.azure.com:5432/postgres?sslmode=require'
